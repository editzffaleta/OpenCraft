...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  resolveAccount: (cfg: OpenCraftConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: OpenCraftConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: OpenCraftConfig) => string;
  setAccountEnabled?: (params: {
    cfg: OpenCraftConfig;
    accountId: string;
    enabled: boolean;
  }) => OpenCraftConfig;
  deleteAccount?: (params: { cfg: OpenCraftConfig; accountId: string }) => OpenCraftConfig;
  isEnabled?: (account: ResolvedAccount, cfg: OpenCraftConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: OpenCraftConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: OpenCraftConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: OpenCraftConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: OpenCraftConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.opencraft.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: OpenCraftConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
...
export type ChannelLifecycleAdapter = {
  onAccountConfigChanged?: (params: {
    prevCfg: OpenCraftConfig;
    nextCfg: OpenCraftConfig;
    accountId: string;
    runtime: RuntimeEnv;
  }) => Promise<void> | void;
...
export type ChannelExecApprovalAdapter = {
  ...
  hasConfiguredDmRoute?: (params: { cfg: OpenCraftConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: OpenCraftConfig; accountId?: string | null }) =>
    | {
