...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: OpenCraftConfig): string | undefined {
  ...
  function listAccountIds(cfg: OpenCraftConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: OpenCraftConfig): string {
