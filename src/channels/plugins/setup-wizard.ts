...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: OpenCraftConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: OpenCraftConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: OpenCraftConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: OpenCraftConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: OpenCraftConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: OpenCraftConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: OpenCraftConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: OpenCraftConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: OpenCraftConfig;
    accountId: string;
