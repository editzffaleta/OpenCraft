...
function resolveAvatarSource(cfg: OpenCraftConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OpenCraftConfig, agentId: string): AgentAvatarResolution {
