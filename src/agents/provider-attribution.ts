...
const OPENCRAFT_ATTRIBUTION_PRODUCT = "OpenCraft";
const OPENCRAFT_ATTRIBUTION_ORIGINATOR = "opencraft";

export function resolveProviderAttributionIdentity(
  env: RuntimeVersionEnv = process.env as RuntimeVersionEnv,
): ProviderAttributionIdentity {
  return {
    product: OPENCRAFT_ATTRIBUTION_PRODUCT,
...
function buildOpenAIAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      originator: OPENCRAFT_ATTRIBUTION_ORIGINATOR,
      "User-Agent": `${OPENCRAFT_ATTRIBUTION_ORIGINATOR}/${identity.version}`,
    },
  };
}
