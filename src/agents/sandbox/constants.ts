...
export const DEFAULT_SANDBOX_IMAGE = "opencraft-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "opencraft-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "opencraft-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "opencraft-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "opencraft-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "opencraft-sandbox-browser";
