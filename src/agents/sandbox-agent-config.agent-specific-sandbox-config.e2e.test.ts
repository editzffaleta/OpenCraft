...
async function resolveContext(config: OpenCraftConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): OpenCraftConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
