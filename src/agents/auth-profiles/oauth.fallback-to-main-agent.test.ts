...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveOpenCraftAgentDir() returns mainAgentDir
    process.env.OPENCRAFT_STATE_DIR = tmpDir;
    process.env.OPENCRAFT_AGENT_DIR = mainAgentDir;
