...
describe("subagent announce formatting", () => {
  ...
  beforeAll(async () => {
    ...
    // See: https://github.com/editzffaleta/OpenCraft/issues/31298
    previousFastTestEnv = process.env.OPENCRAFT_TEST_FAST;
  ...
  beforeEach(() => {
    // OPENCRAFT_TEST_FAST is set in beforeAll before module import
  ...
  it("sends instructional message to main agent with status and findings", async () => {
    ...
    expect(msg).toContain("OpenCraft runtime context (internal):");
