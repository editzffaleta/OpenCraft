...
function resolveAdaptiveReadMaxBytes(options?: OpenCraftReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createOpenCraftReadTool(base, {
...
export function createOpenCraftReadTool(
  base: AnyAgentTool,
  options?: OpenCraftReadToolOptions,
): AnyAgentTool {
