...
const CLEANUP_STATE_KEY = Symbol.for("opencraft.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("opencraft.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("opencraft.sessionWriteLockWatchdogState");
