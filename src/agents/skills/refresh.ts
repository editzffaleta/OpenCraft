...
function resolveWatchPaths(workspaceDir: string, config?: OpenCraftConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: OpenCraftConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpenCraftConfig }) {
