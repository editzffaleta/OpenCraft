...
const shouldWarnCompatImport =
  ...
  process.env.OPENCRAFT_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "opencraft/plugin-sdk/compat is deprecated for new plugins. Migrate to focused opencraft/plugin-sdk/<subpath> imports.",
    {
      code: "OPENCRAFT_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
