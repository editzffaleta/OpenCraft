...
type DefineChannelPluginEntryOptions<TPlugin extends ChannelPlugin = ChannelPlugin> = {
  ...
  registerFull?: (api: OpenCraftPluginApi) => void;
};
...
type DefinePluginEntryOptions = {
  ...
  name: string;
  description: string;
  kind?: OpenCraftPluginDefinition["kind"];
  configSchema?: OpenCraftPluginConfigSchema | (() => OpenCraftPluginConfigSchema);
...
type DefinedPluginEntry = {
  ...
  register: NonNullable<OpenCraftPluginDefinition["register"]>;
} & Pick<OpenCraftPluginDefinition, "kind">;
