...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof OpenCraftConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: OpenCraftConfig; env: NodeJS.ProcessEnv }): {
  cfg: OpenCraftConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
