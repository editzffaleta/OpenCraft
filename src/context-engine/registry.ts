...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("opencraft.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("opencraft.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: OpenCraftConfig): Promise<ContextEngine> {
