...
describe("createChildAdapter", () => {
  const originalServiceMarker = process.env.OPENCRAFT_SERVICE_MARKER;
  ...
  beforeEach(() => {
    ...
    delete process.env.OPENCRAFT_SERVICE_MARKER;
  });
  ...
  afterAll(() => {
    if (originalServiceMarker === undefined) {
      ...
      process.env.OPENCRAFT_SERVICE_MARKER = originalServiceMarker;
    }
  });
