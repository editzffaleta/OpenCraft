...
export function listAuthProfileStorePaths(config: OpenCraftConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: OpenCraftConfig, stateDir: string): string[] {
