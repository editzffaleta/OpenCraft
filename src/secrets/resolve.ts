...
function resolveResolutionLimits(config: OpenCraftConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: OpenCraftConfig): SecretProviderConfig {
