...
export function applyOpenAIProviderConfig(cfg: OpenCraftConfig): OpenCraftConfig {
...
export function applyOpenAIConfig(cfg: OpenCraftConfig): OpenCraftConfig {
...
export function applyOpencodeGoModelDefault(cfg: OpenCraftConfig): {
  next: OpenCraftConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: OpenCraftConfig): {
  next: OpenCraftConfig;
  changed: boolean;
} {
