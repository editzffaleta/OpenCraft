...
type LoginOpenAICodexOAuth =
  (typeof import("opencraft/plugin-sdk/provider-auth"))["loginOpenAICodexOAuth"];
...
type GithubCopilotLoginCommand =
  (typeof import("opencraft/plugin-sdk/provider-auth"))["githubCopilotLoginCommand"];
...
vi.mock("opencraft/plugin-sdk/provider-auth", async (importOriginal) => {
  const actual = await importOriginal<typeof import("opencraft/plugin-sdk/provider-auth")>();
  return {
    ...actual,
