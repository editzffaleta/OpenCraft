...
vi.mock("./loader.js", () => ({
  loadOpenCraftPlugins: (...args: unknown[]) => mocks.loadOpenCraftPlugins(...args),
}));
...
describe("registerPluginCliCommands", () => {
  beforeEach(() => {
    ...
    mocks.loadOpenCraftPlugins.mockReset();
    mocks.loadOpenCraftPlugins.mockReturnValue({
      cliRegistrars: [
        {
  ...
  it("forwards an explicit env to plugin loading", () => {
    ...
    registerPluginCliCommands(program, {} as OpenCraftConfig, env);
