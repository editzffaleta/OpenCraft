...
type RegisteredPluginCommand = OpenCraftPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
function listPluginInvocationKeys(command: OpenCraftPluginCommandDefinition): string[] {
...
function listPluginInvocationNames(command: OpenCraftPluginCommandDefinition): string[] {
