...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: OpenCraftConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: OpenCraftConfig }) {
  ...
  afterEach(() => {
    ...
    delete (globalThis as Record<string, unknown>).__opencraftMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__opencraftMcporterColdStartWarned;
  });
