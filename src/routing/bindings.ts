...
export function listBindings(cfg: OpenCraftConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: OpenCraftConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: OpenCraftConfig) {
