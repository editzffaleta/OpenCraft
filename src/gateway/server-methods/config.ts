...
import type { ConfigValidationIssue, OpenCraftConfig } from "../../config/types.opencraft.js";
import {
...
function parseValidateConfigFromRawOrRespond(
  ...
  snapshot: Awaited<ReturnType<typeof readConfigFileSnapshot>>,
  respond: RespondFn,
): { config: OpenCraftConfig; schema: ConfigSchemaResponse } | null {
...
function loadSchemaWithPlugins(): ConfigSchemaResponse {
  ...
  // our cache. However, both loadConfig() and loadOpenCraftPlugins() already cache
