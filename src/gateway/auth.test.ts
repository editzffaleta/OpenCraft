...
describe("gateway auth", () => {
  ...
  it("resolves token/password from OPENCRAFT gateway env vars", () => {
    expect(
      resolveGatewayAuth({
        authConfig: {},
        env: {
          OPENCRAFT_GATEWAY_TOKEN: "env-token",
          OPENCRAFT_GATEWAY_PASSWORD: "env-password",
  ...
  it("accepts password mode when env provides OPENCRAFT_GATEWAY_PASSWORD", () => {
