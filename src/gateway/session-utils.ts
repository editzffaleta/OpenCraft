...
function listConfiguredAgentIds(cfg: OpenCraftConfig): string[] {
...
export function listAgentsForGateway(cfg: OpenCraftConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OpenCraftConfig): string {
...
function resolveSessionStoreAgentId(cfg: OpenCraftConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: OpenCraftConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
  const storeConfig = cfg.session?.store;
...
export function getSessionDefaults(cfg: OpenCraftConfig): GatewaySessionsDefaults {
