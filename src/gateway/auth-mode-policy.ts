...
export function hasAmbiguousGatewayAuthModeConfig(cfg: OpenCraftConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: OpenCraftConfig): void {
