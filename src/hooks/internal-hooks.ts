/**
 * Hook system for OpenCraft agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __opencraft_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__opencraft_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
