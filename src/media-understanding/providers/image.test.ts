...
const ensureOpenCraftModelsJsonMock = vi.fn(async () => {});
...
vi.mock("../../agents/models-config.js", () => ({
  ensureOpenCraftModelsJson: ensureOpenCraftModelsJsonMock,
}));
...
describe("describeImageWithModel", () => {
  ...
  it("routes minimax-portal image models through the MiniMax VLM endpoint", async () => {
    ...
    expect(ensureOpenCraftModelsJsonMock).toHaveBeenCalled();
