...
export async function drainFormattedSystemEvents(params: {
  ...
  const resolveSystemEventTimezone = (cfg: OpenCraftConfig) => {
  ...
  const formatSystemEventTimestamp = (ts: number, cfg: OpenCraftConfig) => {
...
export async function ensureSkillSnapshot(params: {
  ...
  if (process.env.OPENCRAFT_TEST_FAST === "1") {
