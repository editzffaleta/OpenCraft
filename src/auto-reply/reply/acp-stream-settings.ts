...
function resolveAcpStreamCoalesceIdleMs(cfg: OpenCraftConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: OpenCraftConfig): number {
...
export function resolveAcpProjectionSettings(cfg: OpenCraftConfig): AcpProjectionSettings {
