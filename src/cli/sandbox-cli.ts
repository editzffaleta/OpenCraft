...
const SANDBOX_EXAMPLES = {
  main: [
    ["opencraft sandbox list", "List all sandbox containers."],
    ...
    ["opencraft sandbox recreate --agent mybot", "Recreate agent containers."],
    ["opencraft sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["opencraft sandbox list", "List all sandbox containers."],
    ["opencraft sandbox list --browser", "List only browser containers."],
  ...
  explain: [
    ["opencraft sandbox explain", "Show effective sandbox config."],
    ["opencraft sandbox explain --session agent:main:main", "Explain a specific session."],
    ["opencraft sandbox explain --agent work", "Explain an agent sandbox."],
    ["opencraft sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.opencraft.ai/cli/sandbox")}\n`,
    )
    .action(() => {
