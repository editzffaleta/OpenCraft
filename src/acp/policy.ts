...
export function isAcpEnabledByPolicy(cfg: OpenCraftConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: OpenCraftConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: OpenCraftConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: OpenCraftConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: OpenCraftConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: OpenCraftConfig, agentId: string): boolean {
