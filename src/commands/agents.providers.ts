...
function resolveDefaultAccountId(cfg: OpenCraftConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OpenCraftConfig): boolean {
...
export function summarizeBindings(cfg: OpenCraftConfig, bindings: AgentBinding[]): string[] {
