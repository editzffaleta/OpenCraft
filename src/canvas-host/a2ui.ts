...
export const A2UI_PATH = "/__opencraft__/a2ui";

export const CANVAS_HOST_PATH = "/__opencraft__/canvas";

export const CANVAS_WS_PATH = "/__opencraft__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.opencraftCanvasA2UIAction.postMessage(...)
  // - Android: window.opencraftCanvasA2UIAction.postMessage(...)
  const handlerNames = ["opencraftCanvasA2UIAction"];
  ...
  globalThis.OpenCraft = globalThis.OpenCraft ?? {};
  globalThis.OpenCraft.postMessage = postToNode;
  globalThis.OpenCraft.sendUserAction = sendUserAction;
  globalThis.opencraftPostMessage = postToNode;
  globalThis.opencraftSendUserAction = sendUserAction;
