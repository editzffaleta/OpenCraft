...
import { createAccountListHelpers, type OpenCraftConfig } from "opencraft/plugin-sdk/zalouser";
...
function mergeZalouserAccountConfig(cfg: OpenCraftConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: OpenCraftConfig; accountId?: string | null }) {
