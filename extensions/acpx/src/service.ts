...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "opencraft/plugin-sdk/acpx";
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: OpenCraftPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: OpenCraftPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
