 ...
 */
export function applyChutesProviderConfig(cfg: OpenCraftConfig): OpenCraftConfig {
 ...
 */
export function applyChutesConfig(cfg: OpenCraftConfig): OpenCraftConfig {
...
export function applyChutesApiKeyConfig(cfg: OpenCraftConfig): OpenCraftConfig {
