...
import type { OpenCraftPluginConfigSchema } from "opencraft/plugin-sdk/core";
...
const DEFAULT_SOURCE = "opencraft";
...
export function createOpenShellPluginConfigSchema(): OpenCraftPluginConfigSchema {
