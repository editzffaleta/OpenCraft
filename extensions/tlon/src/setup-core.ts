...
export async function resolveTlonSetupConfigured(cfg: OpenCraftConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: OpenCraftConfig): Promise<string[]> {
