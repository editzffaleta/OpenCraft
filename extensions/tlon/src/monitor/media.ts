...
import { fetchWithSsrFGuard } from "opencraft/plugin-sdk/tlon";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to OpenCraft workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".opencraft", "workspace", "media", "inbound");
 ...
 * Format matches OpenCraft's expected attachment structure.
 */
