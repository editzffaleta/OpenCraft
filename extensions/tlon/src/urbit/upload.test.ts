...
vi.mock("opencraft/plugin-sdk/tlon", async (importOriginal) => {
  const actual = await importOriginal<typeof import("opencraft/plugin-sdk/tlon")>();
  return {
    ...actual,
...
describe("uploadImageFromUrl", () => {
  async function loadUploadMocks() {
    const { fetchWithSsrFGuard } = await import("opencraft/plugin-sdk/tlon");
