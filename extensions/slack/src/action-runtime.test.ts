...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): OpenCraftConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: OpenCraftConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: OpenCraftConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
