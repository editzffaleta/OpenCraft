...
vi.mock("opencraft/plugin-sdk/routing", () => ({
...
vi.mock("opencraft/plugin-sdk/config-runtime", () => ({
...
export function resetSlackSlashMocks() {
  ...
  mocks.resolveStorePathMock.mockReset().mockReturnValue("/tmp/opencraft-sessions.json");
}
