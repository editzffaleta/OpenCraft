...
type BuildCommandTextFromArgs =
  typeof import("opencraft/plugin-sdk/reply-runtime").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("opencraft/plugin-sdk/reply-runtime").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("opencraft/plugin-sdk/reply-runtime").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("opencraft/plugin-sdk/reply-runtime").parseCommandArgs;
type ResolveCommandArgMenu =
  typeof import("opencraft/plugin-sdk/reply-runtime").resolveCommandArgMenu;
