...
vi.mock("opencraft/plugin-sdk/whatsapp", async () => {
  const actual = await vi.importActual<typeof import("opencraft/plugin-sdk/whatsapp")>(
    "opencraft/plugin-sdk/whatsapp",
  );
