import { monitorWebChannel as monitorWebChannelImpl } from "opencraft/plugin-sdk/whatsapp";
...
type MonitorWebChannel = typeof import("opencraft/plugin-sdk/whatsapp").monitorWebChannel;
