import { appendCronStyleCurrentTimeLine } from "opencraft/plugin-sdk/agent-runtime";
import { resolveWhatsAppHeartbeatRecipients } from "opencraft/plugin-sdk/channel-runtime";
...
import { emitHeartbeatEvent, resolveIndicatorType } from "opencraft/plugin-sdk/infra-runtime";
import { resolveHeartbeatVisibility } from "opencraft/plugin-sdk/infra-runtime";
import { resolveHeartbeatReplyPayload } from "opencraft/plugin-sdk/reply-runtime";
import {
  DEFAULT_HEARTBEAT_ACK_MAX_CHARS,
  resolveHeartbeatPrompt,
  stripHeartbeatToken,
} from "opencraft/plugin-sdk/reply-runtime";
import { getReplyFromConfig } from "opencraft/plugin-sdk/reply-runtime";
import { HEARTBEAT_TOKEN } from "opencraft/plugin-sdk/reply-runtime";
import { normalizeMainKey } from "opencraft/plugin-sdk/routing";
import { getChildLogger } from "opencraft/plugin-sdk/runtime-env";
import { redactIdentifier } from "opencraft/plugin-sdk/text-runtime";
