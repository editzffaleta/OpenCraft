import { resolveAckReaction } from "opencraft/plugin-sdk/agent-runtime";
...
import type { TelegramDirectConfig, TelegramGroupConfig } from "opencraft/plugin-sdk/config-runtime";
...
import { DEFAULT_ACCOUNT_ID, resolveThreadSessionKeys } from "opencraft/plugin-sdk/routing";
