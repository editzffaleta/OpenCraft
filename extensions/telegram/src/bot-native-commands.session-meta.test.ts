...
type ResolveConfiguredBindingRouteFn =
  typeof import("opencraft/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("opencraft/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
vi.mock("opencraft/plugin-sdk/channel-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("opencraft/plugin-sdk/channel-runtime")>();
  return {
    ...actual,
