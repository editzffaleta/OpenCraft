...
import type { TelegramAccountConfig } from "opencraft/plugin-sdk/config-runtime";
...
type GetPluginCommandSpecsFn =
  typeof import("opencraft/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
type MatchPluginCommandFn = typeof import("opencraft/plugin-sdk/plugin-runtime").matchPluginCommand;
type ExecutePluginCommandFn =
  typeof import("opencraft/plugin-sdk/plugin-runtime").executePluginCommand;
type DispatchReplyWithBufferedBlockDispatcherFn =
  typeof import("opencraft/plugin-sdk/reply-runtime").dispatchReplyWithBufferedBlockDispatcher;
...
vi.mock("opencraft/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("opencraft/plugin-sdk/reply-runtime", () => ({
...
vi.mock("opencraft/plugin-sdk/channel-runtime", () => ({
