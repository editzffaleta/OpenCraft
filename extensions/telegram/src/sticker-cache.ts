...
import { resolveApiKeyForProvider } from "opencraft/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "opencraft/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
...
import { loadJsonFile, saveJsonFile } from "opencraft/plugin-sdk/json-store";
import { AUTO_IMAGE_KEY_PROVIDERS, DEFAULT_IMAGE_MODELS } from "opencraft/plugin-sdk/media-runtime";
import { resolveAutoImageModel } from "opencraft/plugin-sdk/media-runtime";
import { describeImageFileWithModel } from "opencraft/plugin-sdk/media-understanding-runtime";
import { logVerbose } from "opencraft/plugin-sdk/runtime-env";
import { STATE_DIR } from "opencraft/plugin-sdk/state-paths";
