...
import { removeAckReactionAfterReply } from "opencraft/plugin-sdk/channel-runtime";
import { logAckFailure, logTypingFailure } from "opencraft/plugin-sdk/channel-runtime";
...
import { clearHistoryEntriesIfEnabled } from "opencraft/plugin-sdk/reply-runtime";
...
async function resolveStickerVisionSupport(cfg: OpenCraftConfig, agentId: string) {
  try {
