import { buildAccountScopedAllowlistConfigEditor } from "opencraft/plugin-sdk/allowlist-config-edit";
import {
  collectAllowlistProviderGroupPolicyWarnings,
  collectOpenGroupPolicyRouteAllowlistWarnings,
  createScopedDmSecurityResolver,
} from "opencraft/plugin-sdk/channel-config-helpers";
import { type OutboundSendDeps, resolveOutboundSendDep } from "opencraft/plugin-sdk/channel-runtime";
import { normalizeMessageChannel } from "opencraft/plugin-sdk/channel-runtime";
import { buildOutboundBaseSessionKey, normalizeOutboundThreadId } from "opencraft/plugin-sdk/core";
import { resolveExecApprovalCommandDisplay } from "opencraft/plugin-sdk/infra-runtime";
import { buildExecApprovalPendingReplyPayload } from "opencraft/plugin-sdk/infra-runtime";
import { resolveThreadSessionKeys, type RoutePeer } from "opencraft/plugin-sdk/routing";
import { parseTelegramTopicConversation } from "opencraft/plugin-sdk/telegram";
import {
