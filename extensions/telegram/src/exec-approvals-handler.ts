...
import { resolveExecApprovalSessionTarget } from "opencraft/plugin-sdk/infra-runtime";
import type { ExecApprovalRequest, ExecApprovalResolved } from "opencraft/plugin-sdk/infra-runtime";
import { normalizeAccountId, parseAgentSessionKey } from "opencraft/plugin-sdk/routing";
...
function isHandlerConfigured(params: { cfg: OpenCraftConfig; accountId: string }): boolean {
  const config = resolveTelegramExecApprovalConfig({
    cfg: params.cfg,
    accountId: params.accountId,
  });
