...
import { createFinalizableDraftLifecycle } from "opencraft/plugin-sdk/channel-runtime";
 ...
 */
const TELEGRAM_DRAFT_STREAM_STATE_KEY = Symbol.for("opencraft.telegramDraftStreamState");
