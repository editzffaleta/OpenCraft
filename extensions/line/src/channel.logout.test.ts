import type { OpenCraftConfig, PluginRuntime, ResolvedLineAccount } from "opencraft/plugin-sdk/line";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: OpenCraftConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: OpenCraftConfig; accountId: string }): Promise<{
