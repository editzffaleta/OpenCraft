import type { ChannelSetupAdapter, OpenCraftConfig } from "opencraft/plugin-sdk/setup";
import { DEFAULT_ACCOUNT_ID } from "opencraft/plugin-sdk/setup";
...
export function isLineConfigured(cfg: OpenCraftConfig, accountId: string): boolean {
