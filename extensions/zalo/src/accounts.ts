...
import { createAccountListHelpers, type OpenCraftConfig } from "opencraft/plugin-sdk/zalo";
...
function mergeZaloAccountConfig(cfg: OpenCraftConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: OpenCraftConfig): ResolvedZaloAccount[] {
