...
import { isSecretRef } from "opencraft/plugin-sdk/googlechat";
import { createAccountListHelpers, type OpenCraftConfig } from "opencraft/plugin-sdk/googlechat";
...
export function listEnabledGoogleChatAccounts(cfg: OpenCraftConfig): ResolvedGoogleChatAccount[] {
