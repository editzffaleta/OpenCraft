...
import type { ReplyPayload, OpenCraftConfig } from "opencraft/plugin-sdk/twitch";
import { createReplyPrefixOptions } from "opencraft/plugin-sdk/twitch";
...
export type TwitchMonitorOptions = {
  ...
  accountId: string;
  config: unknown; // OpenCraftConfig
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as OpenCraftConfig;
