...
type WebFetchConfig = NonNullable<OpenCraftConfig["tools"]>["web"] extends infer Web
...
function resolveFetchConfig(cfg?: OpenCraftConfig): WebFetchConfig {
...
export function resolveFirecrawlSearchConfig(cfg?: OpenCraftConfig): FirecrawlSearchConfig {
...
export function resolveFirecrawlFetchConfig(cfg?: OpenCraftConfig): FirecrawlFetchConfig {
...
export function resolveFirecrawlApiKey(cfg?: OpenCraftConfig): string | undefined {
...
export function resolveFirecrawlBaseUrl(cfg?: OpenCraftConfig): string {
  const search = resolveFirecrawlSearchConfig(cfg);
  const fetch = resolveFirecrawlFetchConfig(cfg);
  const configured =
...
export function resolveFirecrawlMaxAgeMs(cfg?: OpenCraftConfig, override?: number): number {
