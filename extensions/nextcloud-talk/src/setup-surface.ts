...
import { hasConfiguredSecretInput } from "opencraft/plugin-sdk/config-runtime";
import { DEFAULT_ACCOUNT_ID } from "opencraft/plugin-sdk/routing";
import { setSetupChannelEnabled } from "opencraft/plugin-sdk/setup";
import { type ChannelSetupWizard } from "opencraft/plugin-sdk/setup";
import { formatDocsLink } from "opencraft/plugin-sdk/setup";
...
export const nextcloudTalkSetupWizard: ChannelSetupWizard = {
  ...
  introNote: {
    ...
    lines: [
      ...
      '2) Run: ./occ talk:bot:install "OpenCraft" "<shared-secret>" "<webhook-url>" --feature reaction',
