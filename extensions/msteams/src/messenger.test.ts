...
import { SILENT_REPLY_TOKEN, type PluginRuntime } from "opencraft/plugin-sdk/msteams";
...
describe("msteams messenger", () => {
  ...
  describe("sendMSTeamsMessages", () => {
    ...
    it("preserves parsed mentions when appending OneDrive fallback file links", async () => {
      const tmpDir = await mkdtemp(path.join(resolvePreferredOpenCraftTmpDir(), "msteams-mention-"));
