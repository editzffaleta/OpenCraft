import { resetSystemEventsForTest } from "opencraft/plugin-sdk/infra-runtime";
...
vi.mock("opencraft/plugin-sdk/config-runtime", async (importOriginal) => {
  ...
  return {
    ...actual,
    resolveStorePath: vi.fn(() => "/tmp/opencraft-sessions.json"),
...
vi.mock("opencraft/plugin-sdk/infra-runtime", () => ({
