import { setSetupChannelEnabled, type ChannelSetupWizard } from "opencraft/plugin-sdk/setup";
import { detectBinary, installSignalCli } from "opencraft/plugin-sdk/setup-tools";
