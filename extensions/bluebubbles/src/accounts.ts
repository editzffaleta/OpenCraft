...
import { createAccountListHelpers, type OpenCraftConfig } from "opencraft/plugin-sdk/bluebubbles";
...
export function listEnabledBlueBubblesAccounts(cfg: OpenCraftConfig): ResolvedBlueBubblesAccount[] {
