...
import { resolveChannelMediaMaxBytes, type OpenCraftConfig } from "opencraft/plugin-sdk/bluebubbles";
...
function resolveMediaLocalRoots(params: { cfg: OpenCraftConfig; accountId?: string }): string[] {
