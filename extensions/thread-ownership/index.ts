import type { OpenCraftConfig, OpenCraftPluginApi } from "opencraft/plugin-sdk/thread-ownership";
...
function resolveOwnershipAgent(config: OpenCraftConfig): { id: string; name: string } {
