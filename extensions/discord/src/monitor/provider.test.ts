...
vi.mock("opencraft/plugin-sdk/plugin-runtime", async () => {
  const actual = await vi.importActual<typeof import("opencraft/plugin-sdk/plugin-runtime")>(
    "opencraft/plugin-sdk/plugin-runtime",
  );
  return {
    ...actual,
