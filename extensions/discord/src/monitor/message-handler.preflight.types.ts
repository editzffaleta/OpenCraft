...
import type { SessionBindingRecord } from "opencraft/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "opencraft/plugin-sdk/reply-runtime";
import type { resolveAgentRoute } from "opencraft/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("opencraft/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("opencraft/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("opencraft/plugin-sdk/config-runtime").OpenCraftConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
