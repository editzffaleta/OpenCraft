...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: OpenCraftPhotosLatestParams) async throws -> OpenCraftPhotosLatestPayload {
        ...
        var results: [OpenCraftPhotoPayload] = []
        ...
        return OpenCraftPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> OpenCraftPhotoPayload
    {
