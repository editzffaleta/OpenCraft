...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.opencraft.gateway"
    private static let nodeService = "ai.opencraft.node"
    private static let talkService = "ai.opencraft.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.opencraft.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.opencraft.gateway.diagnostics")
