...
ASC_KEYCHAIN_SERVICE=opencraft-asc-key
...
```bash
ASC_APP_IDENTIFIER=ai.opencraft.client
# or
...
- The beta flow regenerates `apps/ios/OpenCraft.xcodeproj` from `apps/ios/project.yml` before archiving
