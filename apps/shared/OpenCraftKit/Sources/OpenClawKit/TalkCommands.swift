...
public enum OpenCraftTalkCommand: String, Codable, Sendable {
...
public struct OpenCraftTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct OpenCraftTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
