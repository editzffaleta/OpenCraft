...
public enum OpenCraftCanvasA2UICommand: String, Codable, Sendable {
...
public struct OpenCraftCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct OpenCraftCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
