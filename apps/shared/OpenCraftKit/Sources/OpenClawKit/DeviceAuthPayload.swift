...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: OpenCraftProtocol.AnyCodable]?
    {
        ...
        return [
            "id": OpenCraftProtocol.AnyCodable(identity.deviceId),
            "publicKey": OpenCraftProtocol.AnyCodable(publicKey),
            "signature": OpenCraftProtocol.AnyCodable(signature),
            "signedAt": OpenCraftProtocol.AnyCodable(signedAtMs),
            "nonce": OpenCraftProtocol.AnyCodable(nonce),
        ]
    }
}
