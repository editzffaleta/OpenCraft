...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.opencraft", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.opencraft", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: OpenCraftProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
