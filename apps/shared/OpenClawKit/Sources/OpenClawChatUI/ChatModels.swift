...
public typealias OpenCraftPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias OpenCraftPlatformImage = UIImage
#endif

public struct OpenCraftChatUsageCost: Codable, Hashable, Sendable {
...
public struct OpenCraftChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: OpenCraftChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(OpenCraftChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct OpenCraftChatMessageContent: Codable, Hashable, Sendable {
...
public struct OpenCraftChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [OpenCraftChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: OpenCraftChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [OpenCraftChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: OpenCraftChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(OpenCraftChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([OpenCraftChatMessageContent].self, forKey: .content) {
...
public struct OpenCraftChatHistoryPayload: Codable, Sendable {
...
public struct OpenCraftSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct OpenCraftSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [OpenCraftSessionPreviewItem]
}

public struct OpenCraftSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [OpenCraftSessionPreviewEntry]

    public init(ts: Int, previews: [OpenCraftSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct OpenCraftChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct OpenCraftChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct OpenCraftAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct OpenCraftChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct OpenCraftGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct OpenCraftPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: OpenCraftPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: OpenCraftPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct OpenCraftChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
