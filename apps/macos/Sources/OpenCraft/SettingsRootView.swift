...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .opencraftSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? OpenCraftPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? OpenCraftPaths.stateDirURL.path
...
extension Notification.Name {
    static let opencraftSelectSettingsTab = Notification.Name("opencraftSelectSettingsTab")
}
