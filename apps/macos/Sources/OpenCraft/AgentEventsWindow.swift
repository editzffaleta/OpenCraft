...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: OpenCraftProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": OpenCraftProtocol.AnyCodable("start"),
                "name": OpenCraftProtocol.AnyCodable("bash"),
            ],
            summary: nil)
