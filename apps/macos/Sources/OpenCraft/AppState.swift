...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = OpenCraftConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = OpenCraftConfigFile.url()
    ...
    func syncGatewayConfigNow() {
        ...
        let synced = Self.syncedGatewayRoot(
            currentRoot: OpenCraftConfigFile.loadDict(),
        ...
        OpenCraftConfigFile.saveDict(synced.root)
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/opencraft"
        state.remoteCliPath = ""
        return state
    }
}
