...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.opencraft", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return OpenCraftConfigFile.defaultWorkspaceURL() }
