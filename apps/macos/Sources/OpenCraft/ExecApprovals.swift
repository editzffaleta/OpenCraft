...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.opencraft", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        OpenCraftPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        OpenCraftPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
