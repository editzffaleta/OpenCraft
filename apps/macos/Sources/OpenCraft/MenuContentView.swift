...
/// Menu contents for the OpenCraft menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About OpenCraft") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "OpenCraft Not Configured"
        case .remote:
            "Remote OpenCraft Active"
        case .local:
            "OpenCraft Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .opencraftSelectSettingsTab, object: tab)
        }
    }
