...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.opencraft", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("OpenCraft/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__opencraft__/a2ui/").absoluteString + "?platform=macos"
    }
