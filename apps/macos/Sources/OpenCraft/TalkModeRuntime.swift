...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.opencraft", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.opencraft", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [OpenCraftChatMessage] = messages.compactMap { item in
