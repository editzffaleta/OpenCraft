...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/opencraft/opencraft") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/opencraft/opencraft")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://opencraft.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "OpenCraftBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpenCraftBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "OpenCraftGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpenCraftGitCommit") as? String) ??
            "unknown"
    }
