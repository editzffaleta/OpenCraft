...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.opencraft", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other OpenCraft windows, but below the system’s pop-up menus.
