...
enum UIStrings {
    static let welcomeTitle = "Welcome to OpenCraft"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "opencraft.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: OpenCraftChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g opencraft@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: OpenCraftChatViewModel(
