...
enum OpenCraftConfigFile {
    private static let logger = Logger(subsystem: "ai.opencraft", category: "config")
    ...
    static func stateDirURL() -> URL {
        OpenCraftPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        OpenCraftPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-opencraft-config-file",
            "event": "config.write",
