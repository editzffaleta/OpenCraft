---
summary: "Hubs that link to every OpenCraft doc"
read_when:
...
<Note>
If you are new to OpenCraft, start with [Getting Started](/start/getting-started).
</Note>
...
- [OpenCraft assistant](/start/opencraft)
