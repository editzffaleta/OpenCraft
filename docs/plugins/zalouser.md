...
read_when:
  - You want Zalo Personal (unofficial) support in OpenCraft
...
Zalo Personal support for OpenCraft via a plugin, using native `zca-js` to automate a normal Zalo user account.
