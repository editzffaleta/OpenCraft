...
read_when:
  - You want to place an outbound voice call from OpenCraft
...
Voice calls for OpenCraft via a plugin. Supports outbound notifications and
...
- Use `opencraft voicecall ...` or the `voice_call` tool
