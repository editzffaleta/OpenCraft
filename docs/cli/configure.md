---
summary: "CLI reference for `opencraft configure` (interactive configuration prompts)"
read_when:
...
Tip: `opencraft config` without a subcommand opens the same wizard. Use
`opencraft config get|set|unset` for non-interactive edits.
