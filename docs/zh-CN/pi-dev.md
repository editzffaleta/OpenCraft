...
本指南总结了在 OpenCraft 中开发 Pi 集成的合理工作流程。
...
状态存储在 OpenCraft 状态目录下。默认为 `~/.opencraft`。如果设置了 `OPENCRAFT_STATE_DIR`，则使用该目录。
...
- https://docs.opencraft.ai/testing
- https://docs.opencraft.ai/start/getting-started
