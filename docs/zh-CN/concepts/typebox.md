...
- 生成的 Swift 模型：`apps/macos/Sources/OpenCraftProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/opencraft/opencraft/main/dist/protocol.schema.json
