---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OpenCraft"
read_when:
  - You want Xiaomi MiMo models in OpenCraft
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OpenCraft uses
