---
summary: "Use Synthetic's Anthropic-compatible API in OpenCraft"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. OpenCraft registers it as the
...
Note: OpenCraft's Anthropic client appends `/v1` to the base URL, so use
