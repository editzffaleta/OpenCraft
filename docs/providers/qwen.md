---
summary: "Use Qwen OAuth (free tier) in OpenCraft"
read_when:
  - You want to use Qwen with OpenCraft
...
If you already logged in with the Qwen Code CLI, OpenCraft will sync credentials
