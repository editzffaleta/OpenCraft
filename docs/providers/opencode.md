---
summary: "Use OpenCode Zen and Go catalogs with OpenCraft"
read_when:
...
OpenCode exposes two hosted catalogs in OpenCraft:

- `opencode/...` for the **Zen** catalog
- `opencode-go/...` for the **Go** catalog

Both catalogs use the same OpenCode API key. OpenCraft keeps the runtime provider ids
