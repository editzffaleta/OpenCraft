---
summary: "Como o aplicativo macOS incorpora o WebChat do Gateway e como depurá-lo"
read_when:
  - Depurando a visualização do WebChat no macOS ou porta loopback
title: "WebChat"
---

# WebChat (aplicativo macOS)

O aplicativo da barra de menus do macOS incorpora a UI do WebChat como uma visualização nativa SwiftUI. Ele
...
- Logs: `./scripts/clawlog.sh` (subsistema `ai.opencraft`, categoria `WebChatSwiftUI`).
