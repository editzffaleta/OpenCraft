...
- Same path: run the app from a fixed location (for OpenCraft, `dist/OpenCraft.app`).
...
Workaround: move files into the OpenCraft workspace (`~/.opencraft/workspace`) if you want to avoid per-folder grants.
