...
OpenCraft ships three update channels:
...
When you **explicitly** switch channels with `--channel`, OpenCraft also aligns
the install method:
...
When you switch channels with `opencraft update`, OpenCraft also syncs plugin sources:
