...
export function connectGateway(host: GatewayHost) {
  ...
  const client = new GatewayBrowserClient({
    ...
    clientName: "opencraft-control-ui",
    clientVersion,
    mode: "webchat",
    ...
    onHello: (hello) => {
      ...
      void loadAssistantIdentity(host as unknown as OpenCraftApp);
      void loadAgents(host as unknown as OpenCraftApp);
      void loadHealthState(host as unknown as OpenCraftApp);
      void loadNodes(host as unknown as OpenCraftApp, { quiet: true });
      void loadDevices(host as unknown as OpenCraftApp, { quiet: true });
...
function handleTerminalChatEvent(
  ...
  if (runId && host.refreshSessionsAfterChat.has(runId)) {
    ...
    if (state === "final") {
      void loadSessions(host as unknown as OpenCraftApp, {
  ...
  if (hadToolEvents && state === "final") {
    void loadChatHistory(host as unknown as OpenCraftApp);
    return true;
  }
  return false;
}
...
function handleChatGatewayEvent(host: GatewayHost, payload: ChatEventPayload | undefined) {
  ...
  const state = handleChatEvent(host as unknown as OpenCraftApp, payload);
