...
export const pt_BR: TranslationMap = {
  ...
  cron: {
    ...
    form: {
      ...
      jitterHelp: "Precisa de variação? Use Avançado → Janela de dispersão / Unidade de dispersão.",
      execution: "Execução",
      ...
      deleteAfterRunHelp: "Ideal para lembretes únicos que devem se limpar automaticamente.",
