...
export const es: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "Editar ~/.opencraft/opencraft.json de forma segura.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "¿En el móvil? Copia la URL completa (incluyendo #token=...) desde opencraft dashboard --no-open en tu escritorio.",
    },
    insecure: {
