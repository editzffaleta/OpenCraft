...
const (
	envDocsPiExecutable     = "OPENCRAFT_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "OPENCRAFT_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "OPENCRAFT_DOCS_I18N_PI_PACKAGE_VERSION"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "opencraft", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
