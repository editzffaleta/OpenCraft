...
- Keep product names in English: OpenCraft, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the OpenCraft Gateway, use “Gateway 网关”.
