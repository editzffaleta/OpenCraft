...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "opencraft", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for OpenCraft. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("OpenCraft Issue Label Audit");
