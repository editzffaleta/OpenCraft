...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']opencraft\/plugin-sdk["']/,
    hint: "Use opencraft/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']opencraft\/plugin-sdk\/test-utils["']/,
    hint: "Use opencraft/plugin-sdk/testing for the public extension test seam.",
  },
  {
    pattern: /["']opencraft\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/extensions/* for repo-only helpers, or opencraft/plugin-sdk/testing for public seams.",
  },
  {
