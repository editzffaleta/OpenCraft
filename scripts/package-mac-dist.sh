...
# Output:
# - dist/OpenCraft.app
# - dist/OpenCraft-<version>.zip
# - dist/OpenCraft-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.opencraft.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/OpenCraft.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/OpenCraft-$VERSION.zip"
DMG="$ROOT_DIR/dist/OpenCraft-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/OpenCraft-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/OpenCraft-$VERSION.dSYM.zip"
