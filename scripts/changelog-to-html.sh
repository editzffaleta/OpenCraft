...
if [[ -z "$version_content" ]]; then
  echo "<h2>OpenCraft $VERSION</h2>"
  echo "<p>Latest OpenCraft update.</p>"
  echo "<p><a href=\"https://github.com/editzffaleta/OpenCraft/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
