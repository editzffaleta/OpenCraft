...
- OPENCRAFT_GATEWAY_VERSION = exact package.json version
- OPENCRAFT_MARKETING_VERSION = short iOS/App Store version
- OPENCRAFT_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
OPENCRAFT_GATEWAY_VERSION = ${PACKAGE_VERSION}
OPENCRAFT_MARKETING_VERSION = ${MARKETING_VERSION}
OPENCRAFT_BUILD_VERSION = ${BUILD_NUMBER}
EOF
