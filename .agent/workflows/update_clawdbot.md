---
description: Update OpenCraft from upstream when branch has diverged (ahead/behind)
---

# OpenCraft Upstream Sync Workflow
...
```bash
# Kill running app
pkill -x "OpenCraft" || true

# Move old version
mv /Applications/OpenCraft.app /tmp/OpenCraft-backup.app

# Install new build
cp -R dist/OpenCraft.app /Applications/

# Launch
open /Applications/OpenCraft.app
```
...
# Update opencraft.json with fallback chains
