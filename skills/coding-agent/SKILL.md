...
**⚠️ CRITICAL: Never review PRs in OpenCraft's own project folder!**
...
8. **NEVER start Codex in ~/.opencraft/** - it'll read your soul docs and get weird ideas about the org chart!
9. **NEVER checkout branches in ~/Projects/opencraft/** - that's the LIVE OpenCraft instance!
...
For long-running background tasks, append a wake trigger to your prompt so OpenCraft gets notified immediately when the agent finishes (instead of waiting for the next heartbeat):

```
... your task here.

When completely finished, run this command to notify me:
opencraft system event --text "Done: [brief summary of what was built]" --mode now
```
